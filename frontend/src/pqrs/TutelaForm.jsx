...
// //     // Append new valid files to the existing 'archivos' state
// //     setArchivos((prevArchivos) => [...prevArchivos, ...selectedFiles]);
// //     e.target.value = ""; // Clear the input value so the same file can be selected again after removal if needed
// //   };
...
// //             <div className="politica-texto">
// //               <span className="politica-descripcion">
// //                 Passus IPS conforme a las disposiciones contenidas en la ley
// //                 1581 de 2012 y su decreto reglamentario, como custodio
// //                 responsable y/o encargado del tratamiento de datos personales,
// //                 propenderá por la seguridad y confidencialidad de los datos
// //                 sensibles o personales que se hayan recogido y tratado en
// //                 operaciones tales como la recolección, almacenamiento, uso,
// //                 circulación y supresión de aquella información que se reciba de
// //                 terceros a través de los diferentes canales de recolección de
// //                 información.
// //               </span>
// //               <span className="politica-enlace">
// //                 Acepto la{" "}
// //                 <a
// //                   href="https://passusips.com/nosotros-politica-manejo-datos"
// //                   target="_blank"
