...
function PqrsList() {
  ...
  const fetchPqrs = async (page = 1) => {
    try {
      ...
      // --- INICIO DE LA MODIFICACIÓN CLAVE EN fetchPqrs (misma lógica de parseo que antes) ---
      ...
      // --- FIN DE LA MODIFICACIÓN CLAVE EN fetchPqrs ---
  ...
  return (
    <>
      {/* Si tienes un Navbar, descomenta la siguiente línea */}
      {/* <Navbar /> */}
