...
function ClasificacionesPqrs({ pqrId, pqrCodigo, useIdInUrl = true }) {
    ...
    const handleSyncClasificaciones = async () => {
        try {
            ...
            const response = await api.post(`/pqrs/${urlSegment}/agregar-clasificacion`, {
    ...
    return (
        <div className="dropdown-clasificaciones" ref={ref}>
            ...
            <div className="dropdown-input" onClick={() => setDropdownOpen(!dropdownOpen)}>
            ...
            <button onClick={handleSyncClasificaciones} className="sync-button">
