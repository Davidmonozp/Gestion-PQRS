<!DOCTYPE html
    PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1.0-transitional.dtd">
                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    ...
                    <tr>
                        <td class="body-content">
                            <h1>¡PQR Cerrada por Duplicidad!</h1>

                            <p>Estimado(a) paciente<strong> {{ $pqr->nombre }} {{ $pqr->segundo_nombre }} {{ $pqr->apellido }} {{ $pqr->segundo_apellido }}</strong>,</p>

                            <p> <strong>Reciba un cordial saludo de PASSUS IPS Taller Psicomotriz S.A.S.</strong></p>

                            <p>Hemos recibido su mensaje, registrado bajo el radicado {{ $pqr->pqr_codigo }}. <br><br>

                                <strong>ATENCIÓN:</strong> La PQR con código {{ $pqrDuplicada->pqr_codigo }}, que usted
                                registró, ha sido identificada como una solicitud duplicada y ha sido marcada como
                                <strong>CERRADA.</strong> <br><br>

                                Esto significa que su solicitud será gestionada a través de una PQR principal (Maestra) que usted registró anteriormente bajo el codigo de radicado <strong>{{ $pqrMaestra->pqr_codigo }}</strong>,
                                garantizando una respuesta única y oportuna, evitando procesos redundantes.
                            </p>

                            <p>La PQR principal que continuará el proceso de gestión es:</p>

                            <table class="details-table">
                                <tr>
                                    <th>Su PQR Cerrada (Duplicada)</th>
                                    <td><strong>{{ $pqrDuplicada->pqr_codigo }}</strong></td>
                                </tr>
                                <tr>
                                    <th>PQR Principal (Activa)</th>
                                    <td><strong style="color: #004d99;">{{ $pqrMaestra->pqr_codigo }}</strong></td>
                                </tr>
                                <tr>
                                    <th>Estado de su PQR</th>
                                    <td>Cerrada por Duplicidad</td>
                                </tr>
                            </table> <br>
