...
<head>
    ...
    <style type="text/css">
        ...
        .info-section {
            ...
            /* Un color ligeramente diferente para la sección de info */
                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    ...
                    <tr>
                        <td class="body-content">
                            ...
                            <p>Hemos recibido su mensaje, registrado bajo el radicado [número de radicado], y queremos
                                expresarle nuestro más sincero agradecimiento.</p>

                            <p>Sus palabras de felicitación son un valioso reconocimiento que nos inspira a seguir
                                fortaleciendo nuestro compromiso con la humanización, la calidad en la atención y la
                                mejora permanente de nuestros servicios. Cada expresión positiva que recibimos se
                                convierte en un estímulo para continuar trabajando con dedicación, excelencia y
                                responsabilidad por el bienestar de nuestros usuarios y sus familias.</p>

                            <P>Gracias por depositar su confianza en nosotros. Continuaremos esforzándonos para superar
                                sus expectativas y brindar siempre la mejor experiencia en salud y bienestar.</P>
