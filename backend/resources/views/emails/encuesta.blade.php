...
<head>
    ...
    <title>Encuesta de satisfacción a su PQR: {{ $pqr->pqr_codigo }}</title>
    <style type="text/css">
                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    ...
                    <tr>
                        <td class="body-content">
                            <h1>Queremos conocer tu experiencia</h1>

                            <p>Tu PQRS con código <span class="codigo-pqr">**{{ $pqr->pqr_codigo }}**</span> ha sido
                                cerrada</p>

                            <p>Por favor ayúdanos respondiendo una breve encuesta de satisfacción:</p>
                            <div style="text-align: center; margin: 20px 0;">
                                <a class="boton-responder-encuesta"
                                 href="http://localhost:5173/encuesta/{{ $encuesta->token }}">
                                    {{-- href="https://test-fpqrs.passus.cloud/encuesta/{{ $encuesta->token }}"> --}}
                                    Responder encuesta
                                </a>
                            ...
                            <div class="pqr-info-box">
                                ...
                                @if (isset($respuesta->fecha_respuesta) && $respuesta->fecha_respuesta)
                                    ...
                                    <p><strong>Fecha de Respuesta:</strong>
                                        {{ Carbon\Carbon::parse($respuesta->fecha_respuesta)->format('d/m/Y H:i') }}</p>
                                @endif
                            </div>
