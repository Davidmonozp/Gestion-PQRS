...
<head>
    ...
    <style type="text/css">
        ...
        .pqr-info-box {
            ...
            /* Fondo gris claro para la información de PQR */
        ...
        .response-quote {
            ...
            /* Un azul muy claro para el fondo de la respuesta */
            border-left: 4px solid #0056b3;
            /* Borde más oscuro para la cita */
            padding: 20px;
            margin: 25px 0;
            /* Espaciado antes y después */
            border-radius: 4px;
            font-style: italic;
            /* Para que la respuesta se vea como una cita */
            color: #444444;
            text-align: justify;
        ...
        .response-quote p {
            margin: 0;
            /* Asegura que no haya márgenes extra dentro del blockquote */
        }
                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    ...
                    <tr>
                        <td class="body-content">
                            <h1>Respuesta a la {{ $pqr->tipo_solicitud }}</h1>

                            <p>Cordial saludo.</p>

                            <p>Señor Juez <strong>{{ $pqr->registrador_apellido }}</strong> del <strong>{{ $pqr->registrador_nombre }}</strong>:</p>

                            <p>En atención al auto emitido dentro del trámite de la Acción de Tutela {{ $pqr->radicado_juzgado }} y en cumplimiento de lo ordenado, respetuosamente me permito allegar el Informe de Cumplimiento y la Respuesta de Fondo definitiva correspondiente a la acción interpuesta por el(la) señor(a) {{ $pqr->nombre }} {{ $pqr->segundo_nombre }} {{ $pqr->apellido }}
                                {{ $pqr->segundo_apellido }}, junto con los soportes correspondientes.</p>

                            <p>Agradeceremos que se nos acuse recibo de la presente notificación.</p>

                            <p>En el adjunto a este correo, encontrará el documento completo con la Respuesta de Fondo definitiva y el Informe de Cumplimiento ordenado por el juzgado, junto con sus respectivos soportes.</p>

                            <p>La información adjunta contiene:</p>

                            <div class="pqr-info-box">
                                <p><strong>Radicado Passus:</strong> <span
                                        style="font-size: 1.1em; color: #007bff; font-weight: bold;">{{ $pqr->pqr_codigo }}</span>
                                </p>
                                <p><strong>Radicado del Juzgado:</strong> <span
                                        style="font-size: 1.1em; color: #007bff; font-weight: bold;">{{ $pqr->radicado_juzgado }}</span>
                                </p>
                                <p><strong>Tipo de Solicitud:</strong> {{ $pqr->tipo_solicitud }}</p>
                                <p><strong>Estado Actual:</strong> <span
                                        style="font-weight: bold; color: #28a745;">Contestada</span></p>
                                {{-- @if (isset($pqr->created_at) && $pqr->created_at)
                                    <p><strong>Fecha de Registro:</strong>
                                        {{ Carbon\Carbon::parse($pqr->created_at)->format('d/m/Y H:i') }}</p>
                                @endif --}}
                                @if (isset($respuesta->fecha_respuesta) && $respuesta->fecha_respuesta)
                                    {{-- Asumiendo que $respuesta tiene una fecha de respuesta --}}
                            ...
                            <a href="{{ url('https://passusips.com/index.php') }}" target="_blank"
                                ...
                                <img style="width: 200px;"
                                    src="data:image/png;base64,"
                                    alt="Passus IPS Logo" border="0">
                            </a>
