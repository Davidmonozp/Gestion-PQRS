                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    ...
                    <tr>
                        <td class="body-content">
                            ...
                            <p>Se te ha asignado la siguiente PQR: {{ $pqr->pqr_codigo }}</p>

                            <p>Por favor, revisa los detalles a
                                continuación y procede con su gestión lo antes posible.</p>
                            ...
                            <p>Accede directamente al sistema para revisar todos los detalles de esta PQR y comenzar a
                                trabajar en ella.</p>


                            <hr class="divider">

                            <p>Agradecemos tu diligencia y compromiso en la atención de las solicitudes de nuestros
                                usuarios.</p>
